...
export const problems = [
  ...
  },
  {
    type: '地方行政',
    subtext:
      'ちなみに「地方公務員」には、福祉部門、福祉を除く一般行政部門、教育部門、警察部門、消防部門、公営企業等会計部門が含まれます。',
    text:
  ...
  },
  {
    ...
    factfulness: (
      <>
        「金メダルの数なんかどうでもいい」と思う方もいるかもしれないが、スポーツ界では金メダル数の数値目標が掲げられている。たとえば文部科学省は、
        <ExternalLink href="http://www.mext.go.jp/component/a_menu/sports/detail/__icsFiles/afieldfile/2012/04/02/1319359_3_1.pdf">
          2012年のスポーツ基本計画において
        </ExternalLink>
        、「金メダル獲得5位以上が目標」と書いている。もちろんJOCも、2020年のオリンピックに向けて金メダル獲得数の数値目標を
        <ExternalLink href="https://www.nikkei.com/article/DGXLSSXK20609_05062018000000/">
          公言している
        </ExternalLink>
        。このJOCの目標を、文科省は
  ...
  },
  {
    type: '農業',
    text:
      '2015年時点で、日本の農業には約130万戸の「家族経営体」(いわゆる家族農業)と約2万の「法人経営体」(いわゆる企業)が関わっています。では、農産物の販売金額全体のうち「法人経営体による販売金額」が占める割合は約何パーセントだったでしょう？',
    ...
    explanation: (
      <>
        ...
        。日本の農業は長らく家族農業が主体だったが、法人経営の存在感が増してきているということだ。とはいえ、販売総額の40%にはまだ届かないが。ちなみに労働人口を見ても、販売農家における常雇い人数が10年間で1.6倍になるなど、世帯員から雇用者への労働力のシフトも進展している。(常雇いとは、7か月以上の期間を定めて雇った人のこと。)
      </>
    ),
    trust: (
