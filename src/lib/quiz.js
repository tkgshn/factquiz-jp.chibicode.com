...
export const problems = [
  {
    ...
    factfulness: (
      <>
        ...
        <strong>直線本能</strong>
        」について書かれている。高齢者の数は2040年後半には減少していく。このままひたすら直線的に増え続けることはない。もちろん社会の高齢化は進むし、若者の絶対数は減り続けるが、高齢者の絶対数が増え続けるわけではない。たとえば介護施設を作り続けたりするのは愚策だ。
      </>
    ),
    trust: (
      <>
  ...
  },
  {
    ...
    explanation: (
      <>
        ...
        (一次ソースは同じ法務省のデータ)、在留外国人は圧倒的に若者が多い。一方で日本人の若者は少ないため、若者同士の比率で見ると先ほどの倍以上になる。
      </>
    ),
    factfulness: (
      <>
