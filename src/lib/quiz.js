...
export const problems = [
  {
    ...
    explanation: (
      <>
        ...
        。つまり今とほとんど変わらない。ピークの2042年でも今より10%多いくらいだ。ちなみにこれは死亡中位・出生中位という最も現実的なシナリオでの推計。
      </>
    ),
    trust: (
      <>
        人口予測はかなり正確だが、この問題はさらに予測しやすい。2059年の65歳以上人口は、2019年の25歳以上人口とその死亡率が基になるからだ。転入数・転出数(移民など)も影響するが、それを踏まえても700万人近い誤差がでないと「今と比べて20%ほど増える」にならない。
      </>
    ),
    answer: 'a'
  },
