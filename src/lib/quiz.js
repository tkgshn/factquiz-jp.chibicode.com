...
export const problems = [
  {
    ...
    explanation: (
      <>
        ...
        。つまり今とほとんど変わらない。ちなみにこれは死亡中位・出生中位という最も現実的なシナリオでの推計。
      </>
    ),
    trust: (
      <>
        人口予測はかなり正確だが、この問題はさらに予測しやすい。2059年の65歳以上人口は、2019年の25歳以上人口が基になるからだ。死亡数や転入数・転出数(移民など)も影響するが、1000万人以上の誤差が出ることはないだろう。
      </>
    ),
    answer: 'b'
  },
  {
    ...
    trust: (
      <>
        高齢者の人口は分かっているし、死者が出る交通事故は今回のソース元である警察がほぼ正確に把握していると思われる。
      </>
    ),
    answer: 'a'
  },
  {
    ...
    trust: (
      <>
        ...
        この質問に5%と答えた人は実際より400万人、8%と答えた人は実際より800万人も多くの在留外国人がいる、と考えていたことになる。それほどの人数になるには、毎年40万人の外国人を受け入れても、単純計算で10年・20年近くかかる。
      </>
    ),
    answer: 'a'
  },
  {
    type: '地方行政',
    text:
      '2017年の日本において、15~64歳人口の約何パーセントが「地方公務員」として働いているでしょう？(教育・警察・消防・一般行政・公営企業会計など)',
    short: '地方公務員の割合',
    choices: {
      a: '4%',
      b: '8%',
    ...
    explanation: (
      <>
        ...
        。これには一般行政部門・教育部門・警察部門・消防部門・公営企業等会計部門が含まれている。一方、15〜64歳人口は同じく
  ...
  },
  {
    type: '女性の教育',
    text:
      '2018年の日本において、大学の博士課程に在籍している人のうち、女性の割合は約何パーセントでしょう？',
    short: '女性の博士課程在学者の割合',
    choices: {
      a: '10%',
      b: '20%',
    ...
    explanation: (
      <>
        ...
        <strong>33.6%</strong>
        で過去最高。進歩の誇張を避けるため一の位を切り捨てて約30%とした。ちなみにこの割合が30%を超えたのは2005年頃。
      </>
    ),
    trust: (
      <>
        大学のデータを集計したものなので、おそらく誤差は少ないだろう。ちなみにこの調査によれば、博士課程在学者数は全体で約7万4000人で、うち女性は約2万5000人。この質問に20%と答えた人は、実際より1万人以上も博士課程の女性が少ないと考えていたことになる。
      </>
    ),
    answer: 'c'
  },
  {
    ...
    explanation: (
      <>
        ...
        <strong>60.9%</strong>
        。2016年の56.8%から微増した。もっと高くないのは、高齢者のスマートフォン保有率が低いことが原因だろう。
        <ExternalLink href="http://www.soumu.go.jp/johotsusintokei/whitepaper/ja/h30/html/nd142110.html">
          同白書によれば、
        </ExternalLink>
        20代や30代で保有率が90%を超えているのに対し、60代の保有率は45%、70代は19%、80歳以上は6%だ。
      </>
    ),
    trust: (
      <>
...

  {
    ...
    explanation: (
      <>
        ...
        <strong>6.5%</strong>
        と2倍以上になった。「防衛省における女性職員の活躍推進とワークライフバランス推進のための取組計画」では、女性職員の採用・登用について具体的な数値目標が掲げられている。ちなみに自衛隊の事務官を見ると、2017年時点で全事務官の約4人に1人が女性だ。
      </>
    ),
    trust: <>自衛隊の人数についてのデータはほぼ正確だろう。</>,
    answer: 'c'
  },
  {
    type: 'エネルギー',
  ...
  },
  {
    type: 'スポーツ',
    text:
      '1964年に行われた東京オリンピックの後、2016年までに12回の夏季オリンピックが行われました。1964年の東京オリンピックよりも日本が多く金メダルを獲得したのは、この12回のうち何回でしょう？',
    ...
    explanation: (
      <>
        1964年の東京オリンピックで日本は16個の金メダルを獲得した。これより多く日本が金メダルを獲得した大会は無い。ちなみに2004年のアテネオリンピックでも日本は16個の金メダルを獲得した。また、金メダル獲得数の順位でも、1964年の東京オリンピックが3位と最高順位だった。(1968年のメキシコシティでも同じく3位だった。){' '}
        メダルのデータは
  ...
  },
  {
    ...
    explanation: (
      <>
        農林水産省による「食料・農業・農村白書(2016年)」には、5年に1度行われる調査「農林業センサス」のデータが載っている。それによると、「農産物販売金額全体に占める法人経営体の販売金額シェア」は2005年は約15%だったが、2010年には約21%になり、
        <strong>2015年には約27%になった</strong>
        。日本の農業は長らく家族農業が主体だったが、法人経営の存在感が増してきているということだ。労働人口を見ても、販売農家における常雇い人数が10年間で1.6倍になるなど、世帯員から雇用者への労働力のシフトも進展している。(常雇いとは、7か月以上の期間を定めて雇った人)
      </>
    ),
    trust: (
      <>
        誤差は少しはあるかもしれないが、25%から大きく外れることはないように思われる。
      </>
    ),
    answer: 'c'
  }
